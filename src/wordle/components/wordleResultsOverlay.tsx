...
const WordleResultOverlay: React.FC<Props> = ({
  ...
  // Different buttons depending on mode
    ...
    >
      <View style={styles.card}>
        ...
        <View style={styles.buttonsRow}>
          {isDaily ? (
            <>
              {/* Daily: Main Menu + Practice (no Play Again) */}
              <Pressable
              ...
              >
                <Text style={styles.primaryText}>Play Practice</Text>
              </Pressable>
              <Pressable
                style={[styles.button, styles.secondaryButton]}
                onPress={handleShare}
