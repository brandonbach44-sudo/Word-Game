...
const styles = StyleSheet.create({
  ...
  wordsBox: { borderWidth: 2, borderRadius: 14, paddingVertical: 12, paddingHorizontal: 16 },
  wordRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 7 },
